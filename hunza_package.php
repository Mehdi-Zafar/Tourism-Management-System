...
<body>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images\hunza4.jpg" class="d-block w-100" alt="..." />
      </div>
      <div class="carousel-item">
        <img src="images\hunza3.jpg" class="d-block w-100" alt="..." />
      </div>
      <div class="carousel-item">
        <img src="images\hunza2.jpg" class="d-block w-100" alt="..." />
      </div>
    </div>
  ...
  <div>
    <h4>
      Hunza was a princely state, bordering China to the north-east and Pamir
      to its north-west, which continued to survive until 1974, when it was
      finally dissolved by Zulfikar Ali Bhutto. The state bordered the Gilgit
      Agency to the south, the former princely state of Nagar to the east. The
      state capital was the town of Baltit (also known as Karimabad) and its
      old settlement is Ganish Village. Situated at an elevation of 2,438
      meters, Hunza Valley's tourist season is from May to October.
    </h4>
  </div>
  <br />
