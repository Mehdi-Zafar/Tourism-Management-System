...
<body class="bg-dark">
    ...
    <center>
        <h1>
            <div class="p-3 mb-2 bg-dark text-white" id="aboutheading">About Us</div>
        </h1>
    </center>
    ...
    <h4>
        <div class="text-dark" id="abouttext">
            ...
            Travelling is an incredibly vital part of life. It is the best way to break
            your monotonous routine and experience life in different ways.
            ...
            landscapes. Pakistan is full of beautiful and historical places. However,
            the tragedy is that people are more interested in going abroad and talking
            about the beauty they see there, rather than highlighting the grandeur of our
            own country. Our goal is to promote the tourism industry of Pakistan and
    ...
    <div class="card text-center bg-dark" style="border-top: 1px dashed white;">
