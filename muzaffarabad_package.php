...
<head>
    ...
    <title>🆃🅱 Travel Bug | Muzaffarabad Package</title>
...
<body>
            ...
            <li class="nav-item">
                <a class="nav-link active bg-dark text-light" aria-current="page" href="<?php $link_query = "SELECT link from package where Package_id = '$i'";
                                                                                        ...
                                                                                        echo "$link"; ?>"><?php $package_name_query = "SELECT Package_name from package where Package_id = '$i'";
                                                                                                            ...
                                                                                                            if ($package_name == 'Muzaffarabad Package') {
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images\muzaffarabad1.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
                <img src="images\muzaffarabad2.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
                <img src="images\muzaffarabad3.jpg" class="d-block w-100" alt="..." />
            </div>
        </div>
    ...
    <div>
        <h4>
            Muzaffarabad is the capital of Azad Kashmir in Pakistan.
            It is located on the banks of the Jhelum and Neelum rivers.
            The district is bounded by Khyber Pakhtunkhwa Province in
            the west, by the Kupwara and Baramulla districts of on the
            Indian side of the Line of Control in the east, and the Neelum
            District of Azad Kashmir in the north. It is an approximate drive
            of 4 hour from Islamabad, capital city of Pakistan. It is a stopover
            to the main tourist attractions of Kashmir. A beautiful place
    ...
    <div>
        <h4>
            <?php $Packagedesc_query = "SELECT Package_desc from package where Package_name = 'Muzaffarabad Package'";
    ...
    <div>
        <h4>
            <?php $Hoteldesc_query = "SELECT Hotel_desc from hotel where Hotel_name = 'Spotlight Hotel'";
    ...
    <center>
        <h4><strong><span class="pricebox"><?php $Packageprice_query = "SELECT Amount_per_person from package where Package_name = 'Muzaffarabad Package'";
