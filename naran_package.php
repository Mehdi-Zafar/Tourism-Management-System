...
<body>
  ...
  <div>
    <h4>
      <?php $Packagedesc_query = "SELECT Package_desc from package where Package_name = 'Naran Package'";
  ...
  <center>
    <h4><strong><span class="pricebox"><?php $Packageprice_query = "SELECT Amount_per_person from package where Package_name = 'Naran Package'";
