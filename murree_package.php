...
<body>
      ...
      <li class="nav-item">
        <a class="nav-link active bg-dark text-light" aria-current="page" href="<?php $link_query = "SELECT link from package where Package_id = '$i'";
                                                                                ...
                                                                                echo "$link"; ?>"><?php $package_name_query = "SELECT Package_name from package where Package_id = '$i'";
                                                                                                  ...
                                                                                                  if ($package_name == 'Murree Package') {
  ...
  <div>
    <h4>
      <?php $Packagedesc_query = "SELECT Package_desc from package where Package_name = 'Murree Package'";
  ...
  <center>
    <h4><strong><span class="pricebox"><?php $Packageprice_query = "SELECT Amount_per_person from package where Package_name = 'Murree Package'";
