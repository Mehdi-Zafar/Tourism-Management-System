...
<head>
    ...
    <title>🆃🅱 Travel Bug | Add Package</title>
...
<body>
    ...
    <div class="container">
        <center>
            <div class="add">
                <form action="addhotelform.php" method="post">
                    <div class="name">
                        <label for="name">Name of Hotel:</label>
                        <input type="text" name="name" id="name" required>
                    </div><br>
                    <div class="type">
                        <label for="type">Hotel type: <br>(eg. 5 star)</label>
                        <input type="text" name="type" id="type" required>
                    </div><br>
                    <div class="address">
                        <label for="address">Hotel Address 1: <br>(eg. Mall road, Murree)</label>
                        <textarea id="address" name="address" rows="4" cols="20" required></textarea>
                    </div><br>
                    <div class="address2">
                        <label for="address2">Hotel Address 2(if any):</label>
                        <textarea id="address2" name="address2" rows="4" cols="20"></textarea>
                    </div><br>
                    <div class="desc">
